...
class Mahasiswa extends CI_Controller
{
	...
	public function tambah_data()
	{
		...
		$data = array('form_open' => $form_open, 'label_nim' =>  $label_nim, 'label_nama' => $label_nama, 'label_prodi' => $label_prodi, 'input_nim' => $input_nim, 'input_nama' => $input_nama, 'dropdown_prodi' => $dropdown_prodi, 'form_submit' => $form_submit, 'error_nim' => $error_nim, 'error_nama' => $error_nama, );
	...
	{
		$attr_nim = array(
			'required' => 'NIM harus diisi!', 'min_length' => 'NIM minimal 8 karakter!', 'max_length' => 'NIM melebihi 8 karakter!', 'numeric' => 'NIM tidak menggunakan huruf!');
		$attr_nama = array( 'required' => 'Nama mahasiswa harus diisi!', 'min_length' => 'Nama mahasiswa minimal 5 karakter!', 'max_length' => 'Nama mahasiswa maksimal 30 karakter!');
		$this->form_validation->set_rules('NIM', 'trim|required|numeric|min_length[8]|max_length[8]', $attr_nim);
