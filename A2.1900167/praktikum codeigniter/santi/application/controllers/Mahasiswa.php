...
class Mahasiswa extends CI_Controller
{
    ...
    public function _rules()
    {
    	...
    	$this->form_validation->set_rules('nim', 'NIM', 'trim|required|numeric|min_length[6]|max_length[8]', $attr_nim);
    	$this->form_validation->set_rules('nama_mhs', 'Nama Mahasiswa', 'trim|required|min_length[1]|max_length[50]', $attr_nama);
    }
    ...
    public function edit($id)
    {
	    ...
	    if ($get_row->num_rows() > 0) {
    		...
    		$form_open = form_open('mahasiswa/tambah_aksi');
         	$label_nim = form_label('NIM','NIM');
        	$label_nama = form_label('Nama Mahasiswa','mana_mhs');
       		$label_prodi = form_label('Program Studi','prodi');
