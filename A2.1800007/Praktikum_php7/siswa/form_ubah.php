					...
					<div class="row">
						<div class="col">
							...
							<div class="form-group col-md-12">
								...
								<select class="form-control" name="agama" autocomplete="off" required>
									<option value="<?php echo $agama; ?>"></option>
						...
						<div class="col">
							...
							<div class="form-group col-md-12">
								...
								<input type="text" class="form-control date-picker" data-date-format="dd-mm-yyy" name="tanggal_lahir" autocomplete="off" value="<?php echo $tanggal_lahir; ?>" required>
