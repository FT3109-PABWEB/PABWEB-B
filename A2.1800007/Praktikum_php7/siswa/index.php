...
<head>
	...
	<meta name="description" content="Aplikasi Pengelolaan Data Siswa dengan PHP 7, MSQLi,dan Bootstrap 4">
	<meta name="keywords" content="Aplikasi Pengelolaan Data Siswa dengan PHP 7, MySQLi, dan Bootstrap 4">
	<meta name="author" content="afifalli">
...
<body>
		...
		<footer class="pt-4 my-md-4 pt-md-3 border-top">
			<div class="row">
				<div class="col-12 col-md center">
					&copy; 2021 - <a class="text-info" href="https://stmik-sumedang.ac.id"><span class="heart"> &#9829;</span> STMIK Sumedang</a>
				</div>
			</div>
		</footer>
	</div>
	...
	<script type="text/javascript" src="assets/plugins/datepicker/js/bootstrap-datepicker.min.all"></script>
	...
	<script type="text/javascript">
		...
		function validasiFile() {
			...
			if (!allowedExtensions.exec(filePath)) {
				alert('Tipe file tidak sesuai. Harap unggah file foto yang memiliki tipe *.jpg atau *.png');
				fileInput.value = '';
				...
				alert('Ukuran file foto lebih dari 1Mb. Harap unggah file foto yang memiliki ukuran maksimal 1 Mb.');
				fileInput.value = '';
				document.getElementById('imagePreview').innerHTML = '<img class="foto-preview" src="foto/default.png"/>';
				return false;
			}
