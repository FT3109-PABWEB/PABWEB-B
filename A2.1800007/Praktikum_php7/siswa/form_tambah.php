					...
					<div class="row">
						...
						<div class="col">
							...
							<div class="from-group col-md-12">
								...
								<input type="text" class="form-control date-picker" data-date-format="dd-mm-yyy" name="tanggal_lahir" autocomplete="off" required placeholder="dd-mm-yyy">
						...
						<div class="col">
							<div class="from-group col-md-12">
								...
								<input type="file" class="form-control-file mb-3" id="foto" name="foto" autocomplete="off" required onchange="return validasiFile()">
